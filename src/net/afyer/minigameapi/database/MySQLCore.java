...
public class MySQLCore extends DataBaseCore
{
    ...
    private static Logger logger = MinigameAPI.getInstance().getLogger();
            ...
            throws SQLException
    {
        String sql = "CREATE TABLE IF NOT EXISTS `" + tableName + "` ( " + fields
                .toCreateString() + (conditions == null ?
                "" :
    ...
    @Override public Connection getConnection()
    {
        ...
        catch (SQLException e)
        {
            ...
            logger.warning("登录URL: " + url);
            logger.warning("登录账户: " + username);
            logger.warning("登录密码: " + password);
        }
        return null;
    }
}
