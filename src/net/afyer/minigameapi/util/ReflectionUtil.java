...
public final class ReflectionUtil
{
            ...
            Class<?>... parameterTypes) throws NoSuchMethodException
    {
        ...
        for (Method method : clazz.getMethods())
        {
            if (!method.getName().equals(methodName) || !DataType
                    .compare(DataType.getPrimitive(method.getParameterTypes()),
                            primitiveTypes))
            {
                continue;
            }
    ...
    public static void setValue(Object instance, String className,
            PackageType packageType, boolean declared, String fieldName, Object value)
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException,
            SecurityException, ClassNotFoundException
    {
    ...
    public enum PackageType
    {
        MINECRAFT_SERVER("net.minecraft.server." + getServerVersion()), CRAFTBUKKIT(
            ...
            "chunkio"), CRAFTBUKKIT_COMMAND(CRAFTBUKKIT,
            ...
            CRAFTBUKKIT, "potion"), CRAFTBUKKIT_PROJECTILES(CRAFTBUKKIT,
    ...
    public enum DataType
    {
        ...
        public static boolean compare(Class<?>[] primary, Class<?>[] secondary)
        {
            ...
            for (int index = 0; index < primary.length; index++)
            {
                ...
                if (primaryClass.equals(secondaryClass) || primaryClass
